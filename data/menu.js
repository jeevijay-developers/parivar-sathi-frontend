export const homes = [
  // { id: 11, title: "Home", href: "/" },
  // { id: 12, title: "OPD Camps", href: "/home-2" },
  // { id: 13, title: "Counselors", href: "/home-3" },
  // { id: 14, title: "Request for OPD camp", href: "/home-4" },
  // { id: 15, title: "Join Us", href: "/home-5" },
...
export const tours = [
  {
    ...
    links: [
      {
        id: 211,
        cityName: "Browse Camps",
        date: "All Regions",
        href: "/all-previous-camps",
      },
      {
        id: 212,
        cityName: "Register OPD",
        date: "Book Your Slot",
        href: "/register-opd-camp",
      },
      {
        id: 213,
        cityName: "Join Us",
...
export const pages = [
  ...
  },
  {
    ...
    subnav: [
      ...
      { id: 524, title: "Blog single", href: "/blog-list-1" },
    ],
  },
